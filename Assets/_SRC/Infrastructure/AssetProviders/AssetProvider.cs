  ...
  public class AssetProvider
  {
    public T Get<T>() where T : MonoBehaviour
    {
      if (Resources.Load(typeof(T).Name) == null)
        throw new Exception("MonoBehaviour not found: " + typeof(T).Name);
    ...
    public T Get<T>(string path) where T : MonoBehaviour
    {
      ...
      if (load == null)
        throw new Exception("MonoBehaviour not found: " + path);
    ...
    public T GetScriptable<T>() where T : ScriptableObject
    {
      ...
      if (load == null)
        throw new Exception("ScriptableObject not found: " + typeof(T).Name);
    ...
    public T[] GetAllScriptable<T>(string path) where T : ScriptableObject
    {
      ...
      if (scriptableObjects == null)
        throw new Exception("ScriptableObjects not found: " + typeof(T).Name);
